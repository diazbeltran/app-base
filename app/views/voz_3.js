...
let timer = null;
export default class Discado_2 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      stylePressInTouchableMic3: {},
      stylePressInCirculoIconoMic3:{},
      stylePressInTouchableMic4: {},
      stylePressInCirculoIconoMic4:{},
    };
    ...
    this.TextInputMultiline3 = React.createRef();
    this.TextInputMultiline4 = React.createRef();
  ...
  validar = async (categoria) => {
    ...
    if (categoria == 'TextInputMultiline2') {
        ...
        if (categoria == 'TextInputMultiline3') {

          let descripcionDanhos = this.TextInputMultiline3.current.devolverMultiTexto() == undefined ? "" : this.TextInputMultiline3.current.devolverMultiTexto();
          ...
          if (descripcionDanhos == '') {
              let respuesta = 'Ingresa una descripción2.';
              this.TextInputMultiline3.current.msjAlert(respuesta);
              return false;
          } else {
              this.TextInputMultiline3.current.msjAlert('');
              return true;
          }
      }


      if (categoria == 'TextInputMultiline4') {

        let descripcionDanhos = this.TextInputMultiline4.current.devolverMultiTexto() == undefined ? "" : this.TextInputMultiline4.current.devolverMultiTexto();
        ...
        if (descripcionDanhos == '') {
            let respuesta = 'Ingresa una descripción2.';
            this.TextInputMultiline4.current.msjAlert(respuesta);
            return false;
        } else {
            this.TextInputMultiline4.current.msjAlert('');
            return true;
        }
      }
  ...
  async startRecording(tipo) {
    try {
        ...
        if (tipo == 3) {
          ...
          let texto = "";                
          texto = this.TextInputMultiline3.current.devolverMultiTexto() == undefined ? "" : this.TextInputMultiline3.current.devolverMultiTexto();
          if (texto.length > 0) {
              console.log("Hay Texto!!!");
              this.setState({ textoActual: texto })
          } else {
          ...
          this.TextInputMultiline3.current.msjAlert("Dictando... ");
      }

      if (tipo == 4) {
        this.setState({ accion: '4' });
        let texto = "";                
        texto = this.TextInputMultiline4.current.devolverMultiTexto() == undefined ? "" : this.TextInputMultiline4.current.devolverMultiTexto();
        if (texto.length > 0) {
            console.log("Hay Texto!!!");
            this.setState({ textoActual: texto })
        } else {
        ...
        this.TextInputMultiline4.current.msjAlert("Dictando... ");
    }
  ...
  onSpeechEndHandler = (e) => {
    ...
    if (this.state.accion === '3') {
      this.TextInputMultiline3.current.msjAlert("");
    }

    if (this.state.accion === '4') {
    this.TextInputMultiline4.current.msjAlert("");
    }
  ...
  onSpeechResultsHandler = (e) => {
    ...
    if (this.state.accion === '3') {
      if (this.state.results != null && this.state.results != '') {
          ...
          this.TextInputMultiline3.current.agregarMultiText(fraseFinal);
  ...
  if (this.state.accion === '4') {
    if (this.state.results != null && this.state.results != '') {
        ...
        this.TextInputMultiline4.current.agregarMultiText(fraseFinal);
  ...
  handlePressIn = async (tipo) => {
    ...
    if(tipo == 2){
      ...
      if(tipo == 3){
        this.setState({
            stylePressInTouchableMic3: { backgroundColor: '#ff3300' },
            stylePressInCirculoIconoMic3: { backgroundColor: "#ff3300", height: 51, width: 51, borderRadius: 25, }
        })
      ...
      if(tipo == 4){
      this.setState({
          stylePressInTouchableMic4: { backgroundColor: '#ff3300' },
          stylePressInCirculoIconoMic4: { backgroundColor: "#ff3300", height: 51, width: 51, borderRadius: 25, }
      })
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <TouchableWithoutFeedback
            ...
            <KeyboardAvoidingView
                  ...
                  <TouchableWithoutFeedback
                    ...
                    <View
                      ...
                      <View
                        ...
                        <View style={styles.textInputBoxMultiline3}>
                {/* {this.state.fontLoaded == true ? (<Text style={styles.caption}>Mensaje</Text>) : (<Text>Loading ... </Text>)} */}
                <Text style={styles.caption}>Mensaje 3</Text>
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
                  ...
                  <TextInputMultiline
                    key="2"
                    texto={this.state.textoMultiLine3}
                    placeholder="Ingrese texto"
                    multiline={true}
                    numberOfLines={10}
                    ref={this.TextInputMultiline3}
                    onBlur={() => this.validar('TextInputMultiline3')}
                    //onBlur={() => this.validarComentarioOnBlur()}
                    maxLength={500}
                    sacarCaracteres={true}
                    categoria={'pass'}
                  ...
                  <TouchableWithoutFeedback
                    ...
                    <View
                      style={[
                        styles.touchableMic,
                        this.state.stylePressInTouchableMic3,
                      ]}>
                      <View
                        style={[
                          styles.circuloIconoMicrofono3,
                          this.state.stylePressInCirculoIconoMic3,
                        ]}>
                        {/* <Icon name="microphone-alt" size={20} color="white"></Icon> */}
                        <Text>3</Text>
                      </View>
              ...
              {/* 3 */}
              <View style={styles.textInputBoxMultiline4}>
                {/* {this.state.fontLoaded == true ? (<Text style={styles.caption}>Mensaje</Text>) : (<Text>Loading ... </Text>)} */}
                <Text style={styles.caption}>Mensaje 4</Text>
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
                  ...
                  <TextInputMultiline
                    ...
                    multiline={true}
                    numberOfLines={10}
                    ref={this.TextInputMultiline4}
                    onBlur={() => this.validar('TextInputMultiline4')}
                    //onBlur={() => this.validarComentarioOnBlur()}
                    maxLength={500}
                    sacarCaracteres={true}
                    categoria={'pass'}
                  ...
                  <TouchableWithoutFeedback
                    ...
                    onPressOut={() => this.handlePressOut(4)}
                    // onPressIn={this.handlePressIn}
                    // onPressOut={this.handlePressOut}
                    activeOpacity={0.6}>
                    <View
                      style={[
                        styles.touchableMic,
                        this.state.stylePressInTouchableMic4,
                      ]}>
                      <View
                        style={[
                          styles.circuloIconoMicrofono4,
                          this.state.stylePressInCirculoIconoMic4,
                        ]}>
                        {/* <Icon name="microphone-alt" size={20} color="white"></Icon> */}
                        <Text>4</Text>
                      </View>
